        ...
        <section class="playlist-intro">
          ...
          <div class="playlist-intro__details detail">
            ...
            <div class="detail__title">
              <h2>گلچین شاد مجلسی آخرهفته‌ها</h2>
            </div>
            ...
            <div class="detail__icons">
              ...
              <label for="intro-like">
                ...
                >
                  <path
                    d="M18 32.975C17.535 32.975 17.085 32.915 16.71 32.78C10.98 30.815 1.875 23.84 1.875 13.535C1.875 8.28499 6.12 4.02499 11.34 4.02499C13.875 4.02499 16.245 5.01499 18 6.78499C19.755 5.01499 22.125 4.02499 24.66 4.02499C29.88 4.02499 34.125 8.29999 34.125 13.535C34.125 23.855 25.02 30.815 19.29 32.78C18.915 32.915 18.465 32.975 18 32.975ZM11.34 6.27499C7.365 6.27499 4.125 9.52999 4.125 13.535C4.125 23.78 13.98 29.48 17.445 30.665C17.715 30.755 18.3 30.755 18.57 30.665C22.02 29.48 31.89 23.795 31.89 13.535C31.89 9.52999 28.65 6.27499 24.675 6.27499C22.395 6.27499 20.28 7.33999 18.915 9.18499C18.495 9.75499 17.535 9.75499 17.115 9.18499C15.72 7.32499 13.62 6.27499 11.34 6.27499Z"
                    fill="white"
                  />
                </svg>
              </label>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div class="music">
                    <figure class="music__image">
                      <img src="@/assets/images/music1.jpg" alt="" />
                      <button>
                        <svg
                          width="28"
                          height="28"
                    ...
                    <div class="music__info info">
                      <p class="info__title">دستبند</p>
                      <p class="info__singer">رهام</p>
                    </div>
                  </div>
                </td>
                <td>دربند</td>
                ...
                <td>
                  <span>04:42</span>
                  <input type="checkbox" id="music-1" class="like" hidden />
                  <label for="music-1">
                    <svg
                      width="24"
                      height="24"
              ...
              <tr class="playing">
                <td>
                  ...
                  >
                    <path
                      d="M16.4166 1.006C16.831 0.923655 17.3802 1.17069 17.3576 1.65346C17.3603 8.55241 17.3609 15.4513 17.3576 22.3503C17.3769 22.7115 17.0369 22.9732 16.7022 22.9984C16.3004 23.0655 15.7758 22.8251 15.7898 22.3622C15.7825 15.4766 15.7884 8.59092 15.7871 1.70592C15.7439 1.3367 16.066 1.03588 16.4166 1.006Z"
                      fill="#FFA928"
                    />
                    <path
                    ...
                    />
                    <path
                      d="M9.91328 9.18662C10.2447 9.06045 10.6716 9.10096 10.922 9.37056C11.0502 9.50471 11.0701 9.69795 11.0688 9.87459C11.0661 11.3163 11.0701 12.7573 11.0668 14.199C11.0754 14.4174 10.9711 14.6386 10.7786 14.7501C10.4306 14.9533 9.93321 14.9294 9.64434 14.6326C9.51418 14.4998 9.49227 14.3065 9.49426 14.1306C9.49758 12.6869 9.49293 11.2432 9.49625 9.79955C9.47633 9.52662 9.65895 9.2756 9.91328 9.18662Z"
                      fill="#FFA928"
                    />
                  </svg>
                </td>
              ...
              <tr>
                ...
                <td>
                  <div class="music">
                    <figure class="music__image">
                      <img src="@/assets/images/music3.jpg" alt="" />
                      <button>
                        <svg
                          width="28"
                          height="28"
                    ...
                    <div class="music__info info">
                      <p class="info__title">عیبی نداره</p>
                      <p class="info__singer">TalkDown</p>
                    </div>
                  </div>
                </td>
                <td>عیبی داره</td>
                ...
                <td>
                  <span>04:42</span>
                  <input type="checkbox" id="music-3" class="like" hidden />
                  <label for="music-3">
                    <svg
                      width="24"
                      height="24"
              ...
              <tr>
                ...
                <td>
                  <div class="music">
                    <figure class="music__image">
                      <img src="@/assets/images/music4.jpg" alt="" />
                      <button>
                        <svg
                          width="28"
                          height="28"
                    ...
                    <div class="music__info info">
                      <p class="info__title">بی معرفت</p>
                      <p class="info__singer">مسعود</p>
                    </div>
                  </div>
                </td>
                <td>بامعرفت</td>
                ...
                <td>
                  <span>04:42</span>
                  <input type="checkbox" id="music-4" class="like" hidden />
                  <label for="music-4">
                    <svg
                      width="24"
                      height="24"
              ...
              <tr>
                ...
                <td>
                  <div class="music">
                    <figure class="music__image">
                      <img src="@/assets/images/music5.jpg" alt="" />
                      <button>
                        <svg
                          width="28"
                          height="28"
                    ...
                    <div class="music__info info">
                      <p class="info__title">الکی</p>
                      <p class="info__singer">علی تی</p>
                    </div>
                  </div>
                </td>
                <td>واقعی</td>
              ...
              <tr>
                ...
                <td>
                  <span>04:42</span>
                  <input type="checkbox" id="music-6" class="like" hidden />
                  <label for="music-6">
                    <svg
                      width="24"
                      height="24"
              ...
              <tr>
                ...
                <td>
                  <div class="music">
                    <figure class="music__image">
                      <img src="@/assets/images/music6.jpg" alt="" />
                      <button>
                        <svg
                          width="28"
                          height="28"
                    ...
                    <div class="music__info info">
                      <p class="info__title">سیگار پشت سیگار</p>
                      <p class="info__singer">رضا یزدانی</p>
                    </div>
                  </div>
                </td>
                <td>تهران تهران</td>
                ...
                <td>
                  <span>04:42</span>
                  <input type="checkbox" id="music-7" class="like" hidden />
                  <label for="music-7">
                    <svg
                      width="24"
                      height="24"
