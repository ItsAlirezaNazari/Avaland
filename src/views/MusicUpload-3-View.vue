        ...
        <main>
          ...
          <div class="upload-area">
            ...
            <div class="upload-area__body">
              <!-- Drop Zoon -->
              <div class="drop-zoon">
                <p class="drop-zoon__paragraph">اتمام بارگذاری</p>
                <input
                  type="file"
                  id="input-music-file"
                ...
                />
                <!-- Progress Bar  -->
                <div id="uploadedFile" class="drop-zoon__bar">
                  <div class="drop-zoon__progress"></div>
                  <span>100%</span>
                </div>
                <!-- End Progress Bar -->
              </div>
          ...
          <div class="music-informations-form">
